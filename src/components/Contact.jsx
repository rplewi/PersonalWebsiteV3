    ...
    return (
        <div ref = {ref} className = " w-full h-60 flex flex-col justify-center items-center gap-4 text-white">
            <a href = "mailto:rlewi0506@gmail.com">
                <button href = "mailto:rlewi0506@gmail.com"className = " p-3 justify-center items-center flex gap-2 border-2 border-color4 rounded-2xl hover:text-white hover:bg-color4 hover:">Contact <FaEnvelope size = "40"/></button>
            </a>
