...
export default function Contact(){
    ...
    return (
        <div ref = {ref} className = " w-full h-60 flex flex-col justify-center items-center gap-4 text-white">
            ...
            <p className="flex justify-center text-center items-center text-xs sm:text-xs md:text-base"> Please feel free to contact me about an internship/ work opportunities, I am always looking to further my experience! </p>
        </div>
    )
}