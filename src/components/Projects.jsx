        ...
        <div className = "pt-20 w-full h-full flex flex-col items-center">
            ...
            <div className = "pt-10 pb-20 gap-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 justify-items-center ">
                    <div className = "col-span-2 ">
                        <Project languages = {"Tailwind CSS and React"} name = {"My Personal Website"} githubLink={"https://github.com/rplewi/PersonalWebsiteV3"} desc = {"This is the second iteration of my personal website, and I decided to take a deeper dive into my website and wanted to create something to display my skills!"} delay = {500}/>
                    </div>
                    ...
                    <div className="row-span-2">
                        ...
                        desc={"This is a description "} delay={1000}></Project>
                    </div>
            </div>
        </div>
    )
