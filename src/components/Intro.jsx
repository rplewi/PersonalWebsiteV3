    ...
    return (
        <div className = "  flex p-60 pb-96 justify-center h-full w-full ">
            <div className = "text-white font-rubik">
                ...
                <motion.div initial={{x:-600}} animate={{x:0}} transition={{delay:1.8}} className = "pt-2"> My Name is,</motion.div>
                ...
                <motion.div initial={{x:1200}} animate={{x:0}} transition={{delay:2.6}} className = "text-white " >Sophomore at Lewis University studying computer science.</motion.div>
            </div>
        </div>
    )
}
